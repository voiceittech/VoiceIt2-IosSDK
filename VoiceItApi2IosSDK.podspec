...
s.source_files = 'VoiceItApi2IosSDK/Classes/**/*.{h,m}','VoiceItApi2IosSDK/Assets/**/*.{wav}'

s.resource_bundles = {
  'VoiceItApi2IosSDK' => ['VoiceItApi2IosSDK/Classes/**/*.{lproj,storyboard,xib,xcassets,strings}','VoiceItApi2IosSDK/Assets/**/*.{wav}']
}
